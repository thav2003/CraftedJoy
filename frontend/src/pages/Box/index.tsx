// @ts-nocheck
import { Breadcrumb, Card, Flex, List, Space, Typography, Image, Button } from 'antd'
...
const BoxPage: React.FC = () => {
  ...
  const [responseBox] = useFetch({
    fetchFunction: () => api.apiBoxAllGet()
  })
  ...
  return (
    <div>
      ...
      <Typography.Title level={2} className='text-center w-full bg-[#FFFFFF] !mb-0'>
        Tạo Crafted gift
      </Typography.Title>
        ...
        <Space direction='vertical' className='w-full ' size={'large'}>
          ...
          <div>
            <List
              ...
              dataSource={responseBox ? responseBox.value : []}
      ...
      <div className='py-10 px-12 lg:px-36 bg-[#FFFFFF]'>
        <Space direction='vertical' className='w-full ' size={'large'}>
          <div className='text-center py-5 bg-primary'>
            <Typography.Text strong className='text-white'>
              Bước 3 Chọn Phụ kiện trong set
            </Typography.Text>
          </div>
          <div>
            <List
