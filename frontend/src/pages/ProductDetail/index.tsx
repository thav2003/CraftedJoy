import { Col, Row, Image, Typography, Flex, Divider, Button, Card, List, Space, App } from 'antd'
...
const ProductDetailPage: React.FC = () => {
  ...
  const [response] = useFetch({ fetchFunction: () => api.apiProductIdGet(Number(productName!)) })
  const item = response ? response : null
    ...
    <div>
      <div className='py-10 px-12 lg:px-36 bg-[#FFFFFF]'>
        <Row gutter={[32, 32]}>
          <Col span={8}>
            <Image
              src={item ? item.productVariants![0].thumbnail! : 'error'}
              height={400}
          ...
          <Col span={8}>
            <Flex vertical gap={20}>
              ...
              <Button type='primary' className='h-fit bg-[#F68C04] hover:!bg-[#F68C04]' onClick={handleAddItem}>
